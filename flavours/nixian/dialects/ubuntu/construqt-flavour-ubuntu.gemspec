...
require 'construqt/flavour/ubuntu/version'

Gem::Specification.new do |spec|
  spec.name          = "construqt-flavour-ubuntu"
  spec.version       = Construqt::Flavour::Ubuntu::VERSION
...
#  spec.test_files    = spec.files.grep(%r{^(test|spec|features)/})
  ...
  spec.add_runtime_dependency "construqt-nixian", "~> 0.8.4"
