          ...
          class Gre < OpenStruct
            ...
            def get_prepare(gre_delegate)
              ...
              if self.ipsec.transport_family.nil? || self.ipsec.transport_family == Construqt::Addresses::IPV6
                my = self.local.first_ipv6
                other = self.other.interface.delegate.local.first_ipv6
                ...
                other = self.other.interface.delegate.local.first_ipv4
                my = self.local.first_ipv4
                mode_v6 = "sit"
                mode_v4 = "gre"
                prefix = 4
              end
            ...
            def create_interfaces(host, name, cfg)
              ...
              prepare.values.map do |cfg|
                ...
                gt = host.region.interfaces.add_device(host, iname,
                  "address" => host.region.network.addresses.add_ip(cfg.my.to_string),
