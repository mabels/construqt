...
require_relative 'construqt/flavour/ciscian/dialect/dlink/version'

Gem::Specification.new do |spec|
  spec.name          = "construqt-flavour-ciscian-dialect-dlink"
  spec.version       = Construqt::Flavour::Ciscian::Dialect::Dlink::VERSION
...
#  spec.test_files    = spec.files.grep(%r{^(test|spec|features)/})
  ...
  spec.add_runtime_dependency "construqt-flavour-ciscian-core", "~> 0.0.1"
