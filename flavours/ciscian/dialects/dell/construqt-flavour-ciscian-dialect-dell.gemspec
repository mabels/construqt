...
require_relative 'construqt/flavour/ciscian/dialect/dell/version'

Gem::Specification.new do |spec|
  spec.name          = "construqt-flavour-ciscian-dialect-dell"
  spec.version       = Construqt::Flavour::Ciscian::Dialect::Dell::VERSION
