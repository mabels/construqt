...
require 'construqt-examples/version'

Gem::Specification.new do |spec|
  spec.name          = "construqt-examples"
  spec.version       = Construqt::VERSION
...
#  spec.test_files    = spec.files.grep(%r{^(test|spec|features)/})
  ...
  spec.add_runtime_dependency "construqt-flavour-ubuntu", "~> 0.8.4"
  spec.add_runtime_dependency "construqt-flavour-mikrotik", "~> 0.8.4"
